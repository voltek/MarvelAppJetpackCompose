package com.voltek.marvelapp.ui.theme
...
val MarvelRed = Color(0xFFFF0000)

val RedPigment = Color(0xFFEA2B1F)
val LiverOrgan = Color(0xFF61210F)
val Sunray = Color(0xFFEDAE49)
val Jasmine = Color(0xFFF9DF74)
val Cornsilk = Color(0xFFF9EDCC)

val StatBackground = Color(0xFFD1EBFF)
val StatIconColor = Color(0xFF7EA3C7)
